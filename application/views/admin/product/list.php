    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                <a href="index.html" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Product List</a>
                    ...
                    <tbody>
                        ...
                        foreach ($products as $item) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $item->frame_id; ?></td>
                                <td><?php echo frame_category($item->category); ?></td>
